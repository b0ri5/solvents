...
http_archive(
    ...
    urls = [
        ...
        "https://github.com/bazelbuild/rules_go/releases/download/v0.43.0/rules_go-v0.27.0.tar.gz",
    ],
)
...
http_archive(
    ...
    urls = [
        ...
        "https://github.com/bazelbuild/bazel-gazelle/releases/download/v0.34.0/bazel-gazelle-v0.23.0.tar.gz",
    ],
)
...
http_archive(
    ...
    urls = ["https://github.com/bazelbuild/rules_nodejs/releases/download/4.7.1/rules_nodejs-4.0.0.tar.gz"],
)
...
http_archive(
    ...
    url = "https://github.com/bazelbuild/rules_python/releases/download/0.27.0/rules_python-0.4.0.tar.gz",
)
