 ...
 * @param {number} d The "common difference" or step between numbers in the sequence
...
const sum_divisors = function(upper, div1, div2) {
  ...
  // Need the combination of div1 * div2 to subtract the double-counting of common mulitples
